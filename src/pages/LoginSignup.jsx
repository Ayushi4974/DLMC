    ...
    <div style={{
      ...
      >
        ...
        <div style={{ marginBottom: '40px' }}>
          <img src={logoImg} alt="DLMC Logo" style={{ height: '48px', width: 'auto', marginBottom: '8px' }} />
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '4px', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            Decentralised Legacy Management Corp
          </p>
        </div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '440px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '28px' }}>
            <img src={logoImg} alt="DLMC Logo" style={{ height: '40px', width: 'auto', margin: '0 auto' }} />
          </div>
